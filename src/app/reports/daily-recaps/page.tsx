    ...
    <AppShell>
      <div className="p-4 md:p-6 max-w-5xl mx-auto space-y-4">
        <div className="flex items-center justify-between border-b pb-3">
          <div>
            <h1 className="text-lg font-bold text-slate-900">Rekapitulasi Harian Kasir</h1>
            <p className="text-xs text-slate-500">Rekap kasir per shift, total penjualan, & audit saldo laci</p>
          </div>
        ...
        <div className="bg-white p-4 rounded-xl border shadow-2xs space-y-3 text-xs">
          <div className="flex items-center justify-between">
            <span className="font-bold text-slate-900 text-sm">Shift Berjalan (Kasir: {shift.employeeName})</span>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 border-t pt-3">
            ...
            <div>
              <span className="text-slate-400 block text-[10px]">Total Omset</span>
