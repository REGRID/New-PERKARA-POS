...
/**
 * Records verified merchant & product corrections to Supabase persistent self-learning memory.
 */
export async function recordLearnedMemory(
  merchantName: string,
  items: Array<{ name: string; category: string; subCategory?: string; price: number }>
) {
  try {
