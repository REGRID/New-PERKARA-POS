                ...
                {items.map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Row 1: Nama Barang, Kode SKU, Harga Satuan, Qty */}
                      <div className="grid grid-cols-1 sm:grid-cols-12 gap-3.5">
                        <div className="sm:col-span-4 space-y-1.5">
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              if (!item.sku) {
                                handleItemChange(idx, "sku", generateItemSku(newName, item.category));
                              }
                            }}
                        ...
                        <div className="sm:col-span-3 space-y-1.5">
                          <label className="text-xs font-bold text-slate-700 flex items-center gap-1">
                            <Tag className="w-3.5 h-3.5 text-indigo-500" /> Kode SKU
                          </label>
                          <input
                            type="text"
                            value={item.sku || generateItemSku(item.name, item.category)}
                            onChange={(e) => handleItemChange(idx, "sku", e.target.value.toUpperCase().trim())}
                            placeholder="RAW-MILK-101"
                            className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 focus:border-emerald-500 text-xs font-bold font-mono text-indigo-900 bg-indigo-50/30 uppercase"
                          />
                        </div>
                        ...
                        <div className="sm:col-span-2 space-y-1.5">
                          <label className="text-xs font-bold text-slate-700 flex items-center gap-1">
                            <Package className="w-3.5 h-3.5 text-slate-500" /> Qty
                          </label>
                          <input
                            type="number"
                            min="1"
